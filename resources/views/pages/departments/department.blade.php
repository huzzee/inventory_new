                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 16px;">{{ $department->department_name }}</td>
                                    ...
                                    <td>
                                        <button class="btn btn-icon waves-effect waves-light btn-danger m-b-5" data-toggle="modal" data-target="#con-close-modal{{$department->id}}"><i class="fa fa-remove"></i></button>
                                    </td>
                                    
                                </tr>

                                <div id="con-close-modal{{$department->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
