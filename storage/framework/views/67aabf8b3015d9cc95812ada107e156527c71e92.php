<?php $__env->startSection('content'); ?>            
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <form action="<?php echo e(route('suppliers.update.'.$sup->id)); ?>" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="col-sm-12 col-xs-12 col-md-12">
                                    ...
                                    <div class="p-20" style="clear: both;">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="sup_name" parsley-trigger="change" required
                                                       placeholder="<?php echo e($sup->sup_name); ?>" class="form-control" value="<?php echo e(old('sup_name')); ?>" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="sup_phone" parsley-trigger="change" required
                                                       placeholder="<?php echo e($sup->sup_phone); ?>" class="form-control" value="<?php echo e(old('sup_phone')); ?>" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="Email" name="sup_email" parsley-trigger="change" required
                                                       placeholder="<?php echo e($sup->sup_email); ?>" class="form-control" value="<?php echo e(old('sup_email')); ?>" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <textarea name="sup_address" id="textarea" class="form-control" maxlength="225" rows="5" placeholder="<?php echo e($sup->sup_address); ?>" value="<?php echo e(old('sup_address')); ?>" required></textarea>
                                                </div>
                                            </div>
